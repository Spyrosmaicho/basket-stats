...
void print_team(team *t,FILE *file)
{
   ...
   if(!file)printf("%-7d | %8d (%d - %d) | %7d | %6d | %6d | %5d | %7d | %4d / %-4d | %4d / %-4d | %4d / %-4d | %6.2f | %6.2f | %6.2f\n",
    points,rebs,off,def,ass,steals,blocks,tos,matches,ft_made,ft_attempted,two_made,two_attempted,three_made,three_attempted,one_percent,two_percent,three_percent);
   else fprintf(file,"%-7d | %8d (%d - %d) | %7d | %6d | %6d | %5d | %7d | %4d / %-4d | %4d / %-4d | %4d / %-4d | %6.2f | %6.2f | %6.2f\n",
    points,rebs,off,def,ass,steals,blocks,tos,matches,ft_made,ft_attempted,two_made,two_attempted,three_made,three_attempted,one_percent,two_percent,three_percent);
}
