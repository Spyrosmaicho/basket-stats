        ...
        switch(choice)
        {
            ...
            case 2:
                ...
                case 6:
                    ...
                    system("clear");
                    printf("Type the name of the csv file: ");
                    char *filename0 = get_line();
                    if(!filename0){
                        free(filename1);
                        free(filename2);
                        error_handler(*ht,*vec,*t,"Could not read csv file.\n");
                    }
                    putchar('\n');
                    system("clear");
                    print_all_players(*vec,filename1,filename2,filename0);
                    free(filename1);
                    free(filename2);
                    free(filename0);
                    break;
                case 7:
                    ...
                    system("clear");
                    print_team_stats(*vec,*t,filename3,filename4,file5);
                    free(filename3);
                    free(filename4);
                    free(file5);
                    break;
